...
export default function Iphone({
  ...
  if (resolvedWidth && resolvedHeight) {
    sizeStyle.width = resolvedWidth;
    sizeStyle.height = resolvedHeight;
  } else if (resolvedWidth) {
    sizeStyle.width = resolvedWidth;
    sizeStyle.aspectRatio = `${PHONE_WIDTH}/${PHONE_HEIGHT}`;
  ...
  const noExplicitSize = !resolvedWidth && !resolvedHeight;

  return (
    <div
      className={`relative inline-block align-middle leading-none ${
        noExplicitSize ? "w-full" : ""
      } ${className}`}
      style={{
        ...sizeStyle,
        ...style,
